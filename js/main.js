...
playerName = window.prompt("What is your name?", "Shure");

// Fetches the current page and returns a page object.
...
// Accepts `slug` parameter and adds it to the `choiceList` array.
...
// Removes last `slug` in the array and returns the previous `slug.`
...
// Turns the page by recording choice and fetching/updating page object.
